  ...
  init() {
    ...
    form.addEventListener('submit', e => {
      ...
      if (user) {
        ...
        /* Sincronizar XP real si ya tiene historial */
...
window.screens.register = {
  render() {
    /* ── Recuperar datos guardados si volvió desde Términos/Privacidad ── */
      ...
      <form id="register-form" class="flex flex-col gap-4 auth-form-max" autocomplete="off">
        <div class="input-group">
          ...
          <input type="text" id="reg-name" class="input-field auth-field"
            autocomplete="off" placeholder="Solo letras" maxlength="255"
            value="${tmp.name || ''}">
  ...
  init() {
    ...
    document.querySelectorAll('.terms-link').forEach(btn => {
      btn.addEventListener('click', e => {
        ...
        window._regFormTemp = {
          ...
          /* contraseñas no se guardan por seguridad */
        };
    ...
    /* Nombre: solo letras en tiempo real */
    ...
    form.addEventListener('submit', e => {
      ...
      /* Guardar usuario */
      const newUser = { email, password:pass, name:name.trim(), role:'user', fecha_nacimiento:birth };
      saved.push(newUser);
      ...
      /* Limpiar datos temporales al registrarse exitosamente */
      window._regFormTemp = null;
